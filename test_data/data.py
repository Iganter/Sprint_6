class TestData:
    ...
    test_data_user1 = ['Вася', 'Тестировщик', 'Питоново 5', 'Сокольники', '+79876543210', '25.06.2025', 'Бонжур']
    test_data_user2 = ['Леонид', 'Разработчик', 'Айтишников 10', 'Пушкинская', '89104512716', '31.12.2025', 'С нг']

    expected_title_dzen = (
        "Дзен — платформа для просмотра и создания контента. "
